...
GODOT_BIN="${GODOT_BIN:-godot}"   # override: GODOT_BIN=/path/to/godot4 ./export.sh
...
rm -rf "$PUBLIC_DIR"
mkdir -p "$PUBLIC_DIR"
cp -r "$RELEASE_DIR/web/." "$PUBLIC_DIR/"
